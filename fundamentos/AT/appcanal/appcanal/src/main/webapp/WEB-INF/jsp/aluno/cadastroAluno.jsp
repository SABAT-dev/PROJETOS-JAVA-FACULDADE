...
<body>
	<div class="container">
		<form action="/aluno/incluir" method="post">		
			...
			<div class="form-group">
				<label>Idade:</label>
				<input type="text" class="form-control" placeholder="Digite a sua idade" name="idade" value="25">
			</div>

			<div class="form-group">
				<label>Mensalidade:</label>
				<input type="text" class="form-control" placeholder="Digite a sua mensalidade" name="mensalidade" value="2100">
			</div>	  		
